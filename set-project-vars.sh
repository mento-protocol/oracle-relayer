...
cache_vars() {
    ...
    echo "project_id=${project_id}" >> "${cache_file}"
    echo "project_name=${project_name}" >> "${cache_file}"
    echo "region=${region}" >> "${cache_file}"
    echo "service_account_email=${service_account_email}" >> "${cache_file}"
    echo "function_name=${function_name}" >> "${cache_file}"
    echo "function_entry_point=${function_entry_point}" >> "${cache_file}"
    echo "topic_name=${topic_name}" >> "${cache_file}"
    printf "✅\n\n"
}
